...
//     srvHeapDesc.NumDescriptors = 16; // Supporte jusqu'� 16 textures
...
//     {
//         MessageBoxA(nullptr, "�chec chargement texture", "Erreur", MB_OK);
//         return false;
//     }
...
//     // Lib�rer l'image via ImageLoader
//     g_imageLoader.ReleaseImage(g_testImage);

//     // Lib�rer les ressources D3D12
...
//     {
//         MessageBoxA(nullptr, "�chec initialisation D3D12", "Erreur", MB_OK);
//         return 0;
//     }

//     if (!LoadAssets())
//     {
//         MessageBoxA(nullptr, "�chec chargement des assets", "Erreur", MB_OK);
//         return 0;
//     }
